    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center space-x-4">
                <Button variant="ghost" size="icon" onClick={() => router.push('/portal/tickets')} className="rounded-none">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2">
                    <Card className="border-none bg-white dark:bg-slate-900 shadow-none border-t-4 border-t-blue-600">
                        <CardHeader>
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    >
                                        <SelectTrigger className="h-11 border-slate-100 bg-slate-50/50">
                                            <SelectValue placeholder="Select a product or asset..." />
                                        </SelectTrigger>
                                        <SelectContent>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        id="subject"
                                        placeholder="Briefly describe the issue (e.g., device not powering on)"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="CRITICAL">Critical - business outage or safety risk</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        id="description"
                                        placeholder="Describe what happened, error messages, frequency, and business impact..."
                                ...
                                <div className="bg-blue-50/50 dark:bg-blue-900/10 p-5 rounded-none flex items-start space-x-4 border border-blue-100/50 dark:border-blue-800/30 shadow-none shadow-blue-500/5">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xs text-blue-700/80 dark:text-blue-200/60 leading-relaxed">
                                            Our system will route your request to the right team and keep you updated as it progresses.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-end space-x-4 pt-6 border-t border-slate-50 mt-8">
                                    ...
                                    <Button type="submit" disabled={isSubmitting} className="min-w-[180px] bg-blue-600 hover:bg-blue-700 shadow-none shadow-blue-500/20 py-6 h-auto">
                ...
                <div className="space-y-6">
                    <Card className="border-none bg-slate-900 dark:bg-slate-800 text-white shadow-none overflow-hidden relative">
                        <div className="absolute top-[-20px] right-[-20px] h-32 w-32 bg-blue-600 rounded-none blur-[60px] opacity-40" />
                        <CardHeader className="relative z-10">
                            <CardTitle className="text-base">Support SLA</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-4 relative z-10">
                            <div className="flex items-center space-x-3 p-3 rounded-none bg-white/5 border border-white/10">
                                <div className="h-2 w-2 rounded-none bg-red-500 animate-pulse" />
                                <span className="text-xs font-semibold">Critical: 2-4 Hours</span>
                            </div>
                            <div className="flex items-center space-x-3 p-3 rounded-none bg-white/5 border border-white/10">
                                <div className="h-2 w-2 rounded-none bg-orange-500" />
                                <span className="text-xs font-semibold">High: Next Day Resolution</span>
                            </div>
                            <div className="flex items-center space-x-3 p-3 rounded-none bg-white/5 border border-white/10">
                                <div className="h-2 w-2 rounded-none bg-blue-500" />
                                <span className="text-xs font-semibold">Standard: 48-72 Hours</span>
                            </div>
                        </CardContent>
                    </Card>

                    <Card className="border-none bg-white dark:bg-slate-900 shadow-none border-l-4 border-l-orange-400">
                        <CardHeader>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="p-4 rounded-none bg-orange-50 dark:bg-orange-900/10 border border-orange-100 dark:border-orange-800/30 text-center">
